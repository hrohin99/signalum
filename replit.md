...
- **Pricing Intelligence:** Manual pricing data tracking for competitor topics. Table with Date, Plan/Tier, Price, Key inclusions, Source columns. Add/delete entries via modal. Pricing keyword detection during capture routing prompts users to add pricing data. Tables: `competitor_pricing`.
